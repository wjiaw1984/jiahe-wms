...
public class ShopContact implements Serializable {
    private static final long serialVersionUID = 4845704943415739451L;
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.erp.ShopContact)) return false;
        cn.com.wms.model.erp.ShopContact other = (cn.com.wms.model.erp.ShopContact) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.erp.ShopContact;
    }
    ...
    public String toString() {
        return "ShopContact(id=" + getId() + ", shopid=" + getShopid() + ", province=" + getProvince() + ", city=" + getCity() + ", district=" + getDistrict() + ", address=" + getAddress() + ", contactName=" + getContactName() + ", phone=" + getPhone() + ")";
    }
