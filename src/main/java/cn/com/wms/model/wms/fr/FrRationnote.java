...
@Data
public class FrRationnote implements Serializable {
    private static final long serialVersionUID = -987399610194220624L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.fr.FrRationnote)) return false;
        cn.com.wms.model.wms.fr.FrRationnote other = (cn.com.wms.model.wms.fr.FrRationnote) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.fr.FrRationnote;
    }
    ...
    public String toString() {
        return "FrRationnote(freshflag=" + getFreshflag() + ", sheetid=" + getSheetid() + ", refSheetid=" + getRefSheetid() + ", shopid=" + getShopid() + ", goodsid=" + getGoodsid() + ", venderid=" + getVenderid() + ", lotno=" + getLotno() + ", realqty=" + getRealqty() + ", badQty=" + getBadQty() + ", sdate=" + getSdate() + ", operator=" + getOperator() + ")";
    }
