...
@Data
public class SdwmsShop implements Serializable {
    private static final long serialVersionUID = 179924497831136640L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.sdwms.SdwmsShop)) return false;
        cn.com.wms.model.wms.sdwms.SdwmsShop other = (cn.com.wms.model.wms.sdwms.SdwmsShop) o;
        ...
        Object this$shopType = getShopType(), other$shopType = other.getShopType();
        if ((this$shopType == null) ? (other$shopType != null) : !this$shopType.equals(other$shopType)) return false;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.sdwms.SdwmsShop;
    }
    ...
    public String toString() {
        return "SdwmsShop(sheetid=" + getSheetid() + ", shopid=" + getShopid() + ", customid=" + getCustomid() + ", name=" + getName() + ", shopType=" + getShopType() + ", manager=" + getManager() + ", linkMan=" + getLinkMan() + ", address=" + getAddress() + ", zipcode=" + getZipcode() + ", tele=" + getTele() + ", fax=" + getFax() + ", eMail=" + getEMail() + ", notes=" + getNotes() + ", status=" + getStatus() + ")";
    }
