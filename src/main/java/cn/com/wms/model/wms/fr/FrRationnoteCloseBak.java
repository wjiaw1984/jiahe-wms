...
@Data
public class FrRationnoteCloseBak implements Serializable {
    private static final long serialVersionUID = -1323542347306748957L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.fr.FrRationnoteCloseBak)) return false;
        cn.com.wms.model.wms.fr.FrRationnoteCloseBak other = (cn.com.wms.model.wms.fr.FrRationnoteCloseBak) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.fr.FrRationnoteCloseBak;
    }
    ...
    public String toString() {
        return "FrRationnoteCloseBak(freshflag=" + getFreshflag() + ", sheetid=" + getSheetid() + ", customid=" + getCustomid() + ", palletZone=" + getPalletZone() + ", shopid=" + getShopid() + ", goodsid=" + getGoodsid() + ", planQty=" + getPlanQty() + ", realQty=" + getRealQty() + ", badQty=" + getBadQty() + ")";
    }
