...
@TableName("SDWMS_PurOver")
 public class SdwmsPurover implements Serializable {
    private static final long serialVersionUID = 528270829955684020L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.sdwms.SdwmsPurover)) return false;
        cn.com.wms.model.wms.sdwms.SdwmsPurover other = (cn.com.wms.model.wms.sdwms.SdwmsPurover) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.sdwms.SdwmsPurover;
    }
    ...
    public String toString() {
        return "SdwmsPurover(sheetid=" + getSheetid() + ", customid=" + getCustomid() + ", pursheetid=" + getPursheetid() + ", flag=" + getFlag() + ", purdate=" + getPurdate() + ", status=" + getStatus() + ", freshflag=" + getFreshflag() + ")";
    }
