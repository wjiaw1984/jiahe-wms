...
@TableName("SDWMS_PD")
@Data
public class SdwmsPd implements Serializable {
    private static final long serialVersionUID = 6834775350628619164L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.sdwms.SdwmsPd)) return false;
        cn.com.wms.model.wms.sdwms.SdwmsPd other = (cn.com.wms.model.wms.sdwms.SdwmsPd) o;
        ...
        if ((this$palletZone == null) ? (other$palletZone != null) : !this$palletZone.equals(other$palletZone))
            return false;
        Object this$pdtype = getPdtype(), other$pdtype = other.getPdtype();
        if ((this$pdtype == null) ? (other$pdtype != null) : !this$pdtype.equals(other$pdtype)) return false;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.sdwms.SdwmsPd;
    }
    ...
    public int hashCode() {
        ...
        Object $pdtype = getPdtype();
        result = result * 59 + (($pdtype == null) ? 43 : $pdtype.hashCode());
    ...
    public String toString() {
        return "SdwmsPd(sheetid=" + getSheetid() + ", customid=" + getCustomid() + ", palletZone=" + getPalletZone() + ", pdtype=" + getPdtype() + ", goodsid=" + getGoodsid() + ", sdate=" + getSdate() + ", status=" + getStatus() + ")";
    }
