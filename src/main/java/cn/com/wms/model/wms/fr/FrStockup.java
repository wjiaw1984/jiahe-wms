...
@Data
public class FrStockup implements Serializable {
    private static final long serialVersionUID = 4654927406743137102L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.fr.FrStockup)) return false;
        cn.com.wms.model.wms.fr.FrStockup other = (cn.com.wms.model.wms.fr.FrStockup) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.fr.FrStockup;
    }
    ...
    public String toString() {
        return "FrStockup(freshflag=" + getFreshflag() + ", wmsid=" + getWmsid() + ", sdate=" + getSdate() + ", goodsid=" + getGoodsid() + ", qty=" + getQty() + ", badQty=" + getBadQty() + ", status=" + getStatus() + ", notes=" + getNotes() + ", operateDate=" + getOperateDate() + ")";
    }
