...
@TableName("FR_RET_BAK")
 public class FrRetBak implements Serializable {
    private static final long serialVersionUID = 1540100658436277610L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.fr.FrRetBak)) return false;
        cn.com.wms.model.wms.fr.FrRetBak other = (cn.com.wms.model.wms.fr.FrRetBak) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.fr.FrRetBak;
    }
    ...
    public String toString() {
        return "FrRetBak(freshFlag=" + getFreshFlag() + ", sheetid=" + getSheetid() + ", venderid=" + getVenderid() + ", goodsid=" + getGoodsid() + ", lotno=" + getLotno() + ", planQty=" + getPlanQty() + ", realQty=" + getRealQty() + ", badQty=" + getBadQty() + ", sdate=" + getSdate() + ", operator=" + getOperator() + ")";
    }
