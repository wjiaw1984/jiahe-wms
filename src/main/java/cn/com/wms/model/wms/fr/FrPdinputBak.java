...
@TableName("FR_PDInPut_BAK")
 public class FrPdinputBak implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.fr.FrPdinputBak)) return false;
        cn.com.wms.model.wms.fr.FrPdinputBak other = (cn.com.wms.model.wms.fr.FrPdinputBak) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.fr.FrPdinputBak;
    }
    ...
    public String toString() {
        return "FrPdinputBak(freshFlag=" + getFreshFlag() + ", sheetid=" + getSheetid() + ", palletZone=" + getPalletZone() + ", goodsid=" + getGoodsid() + ", lotno=" + getLotno() + ", qty=" + getQty() + ", sdate=" + getSdate() + ", operator=" + getOperator() + ")";
    }
