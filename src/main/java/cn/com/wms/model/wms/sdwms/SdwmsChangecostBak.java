...
@Data
public class SdwmsChangecostBak implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.sdwms.SdwmsChangecostBak)) return false;
        cn.com.wms.model.wms.sdwms.SdwmsChangecostBak other = (cn.com.wms.model.wms.sdwms.SdwmsChangecostBak) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.sdwms.SdwmsChangecostBak;
    }
    ...
    public String toString() {
        return "SdwmsChangecostBak(freshflag=" + getFreshflag() + ", sheetid=" + getSheetid() + ", customid=" + getCustomid() + ", palletZone=" + getPalletZone() + ", goodsid=" + getGoodsid() + ", venderid=" + getVenderid() + ", lotno=" + getLotno() + ", cost=" + getCost() + ", notes=" + getNotes() + ", status=" + getStatus() + ", operateDate=" + getOperateDate() + ")";
    }
