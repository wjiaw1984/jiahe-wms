...
@Data
public class FrBadqtychangeBak implements Serializable {
    private static final long serialVersionUID = -237562249654911346L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.fr.FrBadqtychangeBak)) return false;
        cn.com.wms.model.wms.fr.FrBadqtychangeBak other = (cn.com.wms.model.wms.fr.FrBadqtychangeBak) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.fr.FrBadqtychangeBak;
    }
    ...
    public String toString() {
        return "FrBadqtychangeBak(freshFlag=" + getFreshFlag() + ", sheetid=" + getSheetid() + ", customid=" + getCustomid() + ", palletZone=" + getPalletZone() + ", goodsid=" + getGoodsid() + ", lotno=" + getLotno() + ", qty=" + getQty() + ", sdate=" + getSdate() + ", operator=" + getOperator() + ")";
    }
