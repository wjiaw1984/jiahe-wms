...
@TableName("FR_PDYK")
 public class FrPdyk implements Serializable {
    private static final long serialVersionUID = -9042122292653739212L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.fr.FrPdyk)) return false;
        cn.com.wms.model.wms.fr.FrPdyk other = (cn.com.wms.model.wms.fr.FrPdyk) o;
        ...
        Object this$difQty = getDifQty(), other$difQty = other.getDifQty();
        if ((this$difQty == null) ? (other$difQty != null) : !this$difQty.equals(other$difQty)) return false;
        ...
        if ((this$operateDate == null) ? (other$operateDate != null) : !this$operateDate.equals(other$operateDate))
            return false;
        Object this$wasteType = getWasteType(), other$wasteType = other.getWasteType();
        return !((this$wasteType == null) ? (other$wasteType != null) : !this$wasteType.equals(other$wasteType));
    }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.fr.FrPdyk;
    }
    ...
    public int hashCode() {
        ...
        Object $difQty = getDifQty();
        result = result * 59 + (($difQty == null) ? 43 : $difQty.hashCode());
        ...
        result = result * 59 + (($operateDate == null) ? 43 : $operateDate.hashCode());
        Object $wasteType = getWasteType();
        return result * 59 + (($wasteType == null) ? 43 : $wasteType.hashCode());
    }

    public String toString() {
        return "FrPdyk(freshflag=" + getFreshflag() + ", sheetid=" + getSheetid() + ", palletZone=" + getPalletZone() + ", goodsid=" + getGoodsid() + ", venderid=" + getVenderid() + ", lotno=" + getLotno() + ", difQty=" + getDifQty() + ", sdate=" + getSdate() + ", operator=" + getOperator() + ", cost=" + getCost() + ", operateDate=" + getOperateDate() + ", wasteType=" + getWasteType() + ")";
    }
...
/* Location:              D:\wjw\Workspace\jiahe\wms-api.jar!\BOOT-INF\classes\cn\com\wms\model\wms\fr\FrPdyk.class
