...
@Data
public class FrReceiptBak implements Serializable {
    private static final long serialVersionUID = 4078590372885775103L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.fr.FrReceiptBak)) return false;
        cn.com.wms.model.wms.fr.FrReceiptBak other = (cn.com.wms.model.wms.fr.FrReceiptBak) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.fr.FrReceiptBak;
    }
    ...
    public String toString() {
        return "FrReceiptBak(freshflag=" + getFreshflag() + ", sheetid=" + getSheetid() + ", refsheetid=" + getRefsheetid() + ", sdate=" + getSdate() + ", goodsid=" + getGoodsid() + ", venderid=" + getVenderid() + ", lotno=" + getLotno() + ", orerqty=" + getOrerqty() + ", qty=" + getQty() + ", badQty=" + getBadQty() + ", operator=" + getOperator() + ", cost=" + getCost() + ", productDate=" + getProductDate() + ")";
    }
