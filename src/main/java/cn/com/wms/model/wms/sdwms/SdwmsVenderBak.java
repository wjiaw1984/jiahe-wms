...
@Data
public class SdwmsVenderBak implements Serializable {
    private static final long serialVersionUID = -98516943370532956L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.sdwms.SdwmsVenderBak)) return false;
        cn.com.wms.model.wms.sdwms.SdwmsVenderBak other = (cn.com.wms.model.wms.sdwms.SdwmsVenderBak) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.sdwms.SdwmsVenderBak;
    }
    ...
    public String toString() {
        return "SdwmsVenderBak(sheetid=" + getSheetid() + ", venderid=" + getVenderid() + ", customid=" + getCustomid() + ", name=" + getName() + ", manager=" + getManager() + ", linkMan=" + getLinkMan() + ", address=" + getAddress() + ", zipcode=" + getZipcode() + ", tele=" + getTele() + ", fax=" + getFax() + ", eMail=" + getEMail() + ", notes=" + getNotes() + ", orderFlag=" + getOrderFlag() + ", status=" + getStatus() + ")";
    }
