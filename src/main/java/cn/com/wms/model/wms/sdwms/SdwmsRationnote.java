...
@TableName("SDWMS_RationNote")
 public class SdwmsRationnote implements Serializable {
    private static final long serialVersionUID = 6709712062126648379L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.sdwms.SdwmsRationnote)) return false;
        cn.com.wms.model.wms.sdwms.SdwmsRationnote other = (cn.com.wms.model.wms.sdwms.SdwmsRationnote) o;
        ...
        Object this$goodstype = getGoodstype(), other$goodstype = other.getGoodstype();
        ...
        Object this$inShopName = getInShopName(), other$inShopName = other.getInShopName();
        if ((this$inShopName == null) ? (other$inShopName != null) : !this$inShopName.equals(other$inShopName))
            return false;
        Object this$goodsName = getGoodsName(), other$goodsName = other.getGoodsName();
        return !((this$goodsName == null) ? (other$goodsName != null) : !this$goodsName.equals(other$goodsName));
    }

    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.sdwms.SdwmsRationnote;
    }
