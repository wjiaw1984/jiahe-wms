...
@Data
public class SdwmsVender implements Serializable {
    private static final long serialVersionUID = -7547263141399875144L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.sdwms.SdwmsVender)) return false;
        cn.com.wms.model.wms.sdwms.SdwmsVender other = (cn.com.wms.model.wms.sdwms.SdwmsVender) o;
        ...
        Object this$manager = getManager(), other$manager = other.getManager();
        if ((this$manager == null) ? (other$manager != null) : !this$manager.equals(other$manager)) return false;
        Object this$linkMan = getLinkMan(), other$linkMan = other.getLinkMan();
        if ((this$linkMan == null) ? (other$linkMan != null) : !this$linkMan.equals(other$linkMan)) return false;
        Object this$address = getAddress(), other$address = other.getAddress();
        if ((this$address == null) ? (other$address != null) : !this$address.equals(other$address)) return false;
        Object this$zipcode = getZipcode(), other$zipcode = other.getZipcode();
        if ((this$zipcode == null) ? (other$zipcode != null) : !this$zipcode.equals(other$zipcode)) return false;
        Object this$tele = getTele(), other$tele = other.getTele();
        if ((this$tele == null) ? (other$tele != null) : !this$tele.equals(other$tele)) return false;
        Object this$fax = getFax(), other$fax = other.getFax();
        ...
        Object this$orderFlag = getOrderFlag(), other$orderFlag = other.getOrderFlag();
        if ((this$orderFlag == null) ? (other$orderFlag != null) : !this$orderFlag.equals(other$orderFlag))
            return false;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.sdwms.SdwmsVender;
    }
    ...
    public int hashCode() {
        ...
        result = result * 59 + (($linkMan == null) ? 43 : $linkMan.hashCode());
        Object $address = getAddress();
        result = result * 59 + (($address == null) ? 43 : $address.hashCode());
        Object $zipcode = getZipcode();
        result = result * 59 + (($zipcode == null) ? 43 : $zipcode.hashCode());
        Object $tele = getTele();
        result = result * 59 + (($tele == null) ? 43 : $tele.hashCode());
        Object $fax = getFax();
        ...
        Object $orderFlag = getOrderFlag();
        result = result * 59 + (($orderFlag == null) ? 43 : $orderFlag.hashCode());
        Object $status = getStatus();
        return result * 59 + (($status == null) ? 43 : $status.hashCode());
    }

    public String toString() {
        return "SdwmsVender(sheetid=" + getSheetid() + ", venderid=" + getVenderid() + ", customid=" + getCustomid() + ", name=" + getName() + ", manager=" + getManager() + ", linkMan=" + getLinkMan() + ", address=" + getAddress() + ", zipcode=" + getZipcode() + ", tele=" + getTele() + ", fax=" + getFax() + ", eMail=" + getEMail() + ", notes=" + getNotes() + ", orderFlag=" + getOrderFlag() + ", status=" + getStatus() + ")";
    }
