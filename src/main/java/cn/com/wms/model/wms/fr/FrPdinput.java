...
public class FrPdinput implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.wms.fr.FrPdinput)) return false;
        cn.com.wms.model.wms.fr.FrPdinput other = (cn.com.wms.model.wms.fr.FrPdinput) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof cn.com.wms.model.wms.fr.FrPdinput;
    }
    ...
    public String toString() {
        return "FrPdinput(freshFlag=" + getFreshFlag() + ", sheetid=" + getSheetid() + ", palletZone=" + getPalletZone() + ", goodsid=" + getGoodsid() + ", lotno=" + getLotno() + ", qty=" + getQty() + ", sdate=" + getSdate() + ", operator=" + getOperator() + ")";
    }
