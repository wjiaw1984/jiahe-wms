...
import java.util.List;
 ...
 public class RationOutVo implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof cn.com.wms.model.bset.RationOutVo)) return false;
        cn.com.wms.model.bset.RationOutVo other = (cn.com.wms.model.bset.RationOutVo) o;
        ...
        if ((this$totalAmount == null) ? (other$totalAmount != null) : !this$totalAmount.equals(other$totalAmount))
            return false;
        Object this$isPaymentCollected = getIsPaymentCollected(), other$isPaymentCollected = other.getIsPaymentCollected();
        if ((this$isPaymentCollected == null) ? (other$isPaymentCollected != null) : !this$isPaymentCollected.equals(other$isPaymentCollected))
            return false;
        Object this$goodsValue = getGoodsValue(), other$goodsValue = other.getGoodsValue();
        if ((this$goodsValue == null) ? (other$goodsValue != null) : !this$goodsValue.equals(other$goodsValue))
            return false;
        Object this$cheapAmount = getCheapAmount(), other$cheapAmount = other.getCheapAmount();
        if ((this$cheapAmount == null) ? (other$cheapAmount != null) : !this$cheapAmount.equals(other$cheapAmount))
            return false;
        ...
        Object<ItemVo> this$itemList = (Object<ItemVo>) getItemList(), other$itemList = (Object<ItemVo>) other.getItemList();
    ...
    public int hashCode() {
        ...
        Object $isPaymentCollected = getIsPaymentCollected();
        result = result * 59 + (($isPaymentCollected == null) ? 43 : $isPaymentCollected.hashCode());
        Object $goodsValue = getGoodsValue();
        result = result * 59 + (($goodsValue == null) ? 43 : $goodsValue.hashCode());
        Object $cheapAmount = getCheapAmount();
        result = result * 59 + (($cheapAmount == null) ? 43 : $cheapAmount.hashCode());
        ...
        Object<ItemVo> $itemList = (Object<ItemVo>) getItemList();
