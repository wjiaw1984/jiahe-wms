...
public class Item {
    ...
    public static com.best.javaSdk.twSoNotify.request.Item buildForRet(SdwmsRet ret, Integer lineNo) {
        com.best.javaSdk.twSoNotify.request.Item result = new com.best.javaSdk.twSoNotify.request.Item();
    ...
    public static com.best.javaSdk.twSoNotify.request.Item buildForRationNote(SdwmsRationnote sheet, Integer lineNo) {
        ...
        /* 403 */
        result.setItemSkuCode(sheet.getGoodsid().trim());

        /* 405 */
        result.setItemName(sheet.getGoodsName().trim());

        /* 407 */
        //改小数处理
        //result.setItemQuantity(sheet.getPlanQty().setScale(0, RoundingMode.HALF_UP).intValue());
        result.setDecimalQuantity(sheet.getPlanQty().doubleValue());
        /* 408 */
        return result;
    }
}
