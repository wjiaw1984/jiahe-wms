...
public class Receiver {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.best.javaSdk.twSoNotify.request.Receiver)) return false;
        com.best.javaSdk.twSoNotify.request.Receiver other = (com.best.javaSdk.twSoNotify.request.Receiver) o;
        ...
        if ((this$lateDeliveryTime == null) ? (other$lateDeliveryTime != null) : !this$lateDeliveryTime.equals(other$lateDeliveryTime))
            return false;
        Object this$oaId = getOaId(), other$oaId = other.getOaId();
        if ((this$oaId == null) ? (other$oaId != null) : !this$oaId.equals(other$oaId)) return false;
        Object this$street = getStreet(), other$street = other.getStreet();
        if ((this$street == null) ? (other$street != null) : !this$street.equals(other$street)) return false;
        Object this$contactCode = getContactCode(), other$contactCode = other.getContactCode();
        if ((this$contactCode == null) ? (other$contactCode != null) : !this$contactCode.equals(other$contactCode))
            return false;
        Object this$receiverId = getReceiverId(), other$receiverId = other.getReceiverId();
        return !((this$receiverId == null) ? (other$receiverId != null) : !this$receiverId.equals(other$receiverId));
    }

    protected boolean canEqual(Object other) {
        return other instanceof com.best.javaSdk.twSoNotify.request.Receiver;
    }
    ...
    public int hashCode() {
        ...
        result = result * 59 + (($lateDeliveryTime == null) ? 43 : $lateDeliveryTime.hashCode());
        Object $oaId = getOaId();
        result = result * 59 + (($oaId == null) ? 43 : $oaId.hashCode());
        Object $street = getStreet();
        result = result * 59 + (($street == null) ? 43 : $street.hashCode());
        Object $contactCode = getContactCode();
        result = result * 59 + (($contactCode == null) ? 43 : $contactCode.hashCode());
        Object $receiverId = getReceiverId();
        return result * 59 + (($receiverId == null) ? 43 : $receiverId.hashCode());
    }

    public String toString() {
        return "Receiver(name=" + getName() + ", province=" + getProvince() + ", city=" + getCity() + ", district=" + getDistrict() + ", address=" + getAddress() + ", contactName=" + getContactName() + ", phone=" + getPhone() + ", earlyDeliveryTime=" + getEarlyDeliveryTime() + ", lateDeliveryTime=" + getLateDeliveryTime() + ", oaId=" + getOaId() + ", street=" + getStreet() + ", contactCode=" + getContactCode() + ", receiverId=" + getReceiverId() + ")";
    }
