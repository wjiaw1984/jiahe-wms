...
public class Product {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.best.javaSdk.wmsSoStatusPush.request.Product)) return false;
        com.best.javaSdk.wmsSoStatusPush.request.Product other = (com.best.javaSdk.wmsSoStatusPush.request.Product) o;
        ...
        if ((this$decimalDefectiveQty == null) ? (other$decimalDefectiveQty != null) : !this$decimalDefectiveQty.equals(other$decimalDefectiveQty))
            return false;
        if (getAverageWeight() != other.getAverageWeight()) return false;
        ...
        Object this$grossWeight = getGrossWeight(), other$grossWeight = other.getGrossWeight();
    ...
    protected boolean canEqual(Object other) {
        return other instanceof com.best.javaSdk.wmsSoStatusPush.request.Product;
    }
    ...
    public int hashCode() {
        ...
        result = result * 59 + getAverageWeight();
        ...
        Object $grossWeight = getGrossWeight();
        result = result * 59 + (($grossWeight == null) ? 43 : $grossWeight.hashCode());
