...
import com.best.javaSdk.wmsSoStatusPush.response.WmsSoStatusPushRsp;
import lombok.Data;
...
public class WmsSoStatusPushReq implements BaseRequest {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.best.javaSdk.wmsSoStatusPush.request.WmsSoStatusPushReq)) return false;
        com.best.javaSdk.wmsSoStatusPush.request.WmsSoStatusPushReq other = (com.best.javaSdk.wmsSoStatusPush.request.WmsSoStatusPushReq) o;
        ...
        Object this$operatorTime = getOperatorTime(), other$operatorTime = other.getOperatorTime();
        if ((this$operatorTime == null) ? (other$operatorTime != null) : !this$operatorTime.equals(other$operatorTime))
            return false;
        ...
        Object this$totalVolume = getTotalVolume(), other$totalVolume = other.getTotalVolume();
        if ((this$totalVolume == null) ? (other$totalVolume != null) : !this$totalVolume.equals(other$totalVolume))
            return false;
        Object this$totalWeight = getTotalWeight(), other$totalWeight = other.getTotalWeight();
        if ((this$totalWeight == null) ? (other$totalWeight != null) : !this$totalWeight.equals(other$totalWeight))
            return false;
        Object this$totalNetWeight = getTotalNetWeight(), other$totalNetWeight = other.getTotalNetWeight();
        if ((this$totalNetWeight == null) ? (other$totalNetWeight != null) : !this$totalNetWeight.equals(other$totalNetWeight))
            return false;
        if (isWmsCreatedFlag() != other.isWmsCreatedFlag()) return false;
        ...
        Object this$packages = getPackages(), other$packages = other.getPackages();
        return !((this$packages == null) ? (other$packages != null) : !this$packages.equals(other$packages));
    }

    protected boolean canEqual(Object other) {
        return other instanceof com.best.javaSdk.wmsSoStatusPush.request.WmsSoStatusPushReq;
    }
    ...
    public int hashCode() {
        ...
        Object $operatorTime = getOperatorTime();
        result = result * 59 + (($operatorTime == null) ? 43 : $operatorTime.hashCode());
        ...
        Object $totalVolume = getTotalVolume();
        result = result * 59 + (($totalVolume == null) ? 43 : $totalVolume.hashCode());
        Object $totalWeight = getTotalWeight();
        result = result * 59 + (($totalWeight == null) ? 43 : $totalWeight.hashCode());
        Object $totalNetWeight = getTotalNetWeight();
        result = result * 59 + (($totalNetWeight == null) ? 43 : $totalNetWeight.hashCode());
        result = result * 59 + (isWmsCreatedFlag() ? 79 : 97);
    ...
    public BaseResponse makeResponse(String rsp, String format) {
        ...
        if ("xml".equalsIgnoreCase(format)) {
            /*  70 */
            return (BaseResponse) Parser.coverXml2Object(rsp, WmsSoStatusPushRsp.class);
            
        }
        /*  72 */
        return (BaseResponse) Parser.convertJson2Object(rsp, WmsSoStatusPushRsp.class);
    ...
    public List<FrRationnote> toRationNote(String fixString) {
        ...
        /*  84 */
        List<FrRationnote> result = new ArrayList<>();
        
        /*  86 */
        for (Product product : this.products.getProduct()) {
            /*  87 */
            FrRationnote entity = new FrRationnote();
            /*  88 */
            entity.setSheetid(this.orderCode);
            /*  89 */
            String[] orderCodeArr = this.orderCode.split("-");
            /*  90 */
            if (orderCodeArr.length > 1) {
                /*  91 */
                entity.setRefSheetid(orderCodeArr[0]);
                /*  92 */
                entity.setShopid(orderCodeArr[1]);
            } else {
                /*  94 */
                throw new RuntimeException(String.format("处理配送回传单号【%s】发生错误，单据编码不格式不正确！", new Object[]{this.orderCode}));
            }
            /*  96 */
            entity.setSdate(this.operatorTime);
            /*  97 */
            entity.setVenderid("0");
    ...
    public List<FrRet> toFrRet(String fixString) {
        ...
        /* 119 */
        List<FrRet> result = new ArrayList<>();
        
        /* 121 */
        for (Product product : this.products.getProduct()) {
            /* 122 */
            FrRet entity = new FrRet();
            /* 123 */
            entity.setSheetid(this.orderCode);
            ...
            entity.setGoodsid(product.getItemSkuCode());
            /* 130 */
            entity.setVenderid("888888");
            /* 131 */
            entity.setLotno(Integer.valueOf(-1));
            /* 132 */
            entity.setPlanQty(product.getItemQuantity());
            /* 133 */
            //良品数量逻辑
            if ((product.getNormalQuantity() != null && product.getDecimalNormalQty() == null)
                    || (product.getNormalQuantity() != null && product.getDecimalNormalQty() != null
