...
import java.util.Date;
 ...
 public class Batch {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.best.javaSdk.wmsSoStatusPush.request.Batch)) return false;
        com.best.javaSdk.wmsSoStatusPush.request.Batch other = (com.best.javaSdk.wmsSoStatusPush.request.Batch) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof com.best.javaSdk.wmsSoStatusPush.request.Batch;
    }
    ...
    public String toString() {
        return "Batch(fixStatusCode=" + getFixStatusCode() + ", productionDate=" + getProductionDate() + ", expiryDate=" + getExpiryDate() + ", quantity=" + getQuantity() + ", packCode=" + getPackCode() + ", decimalQuantity=" + getDecimalQuantity() + ")";
    }
