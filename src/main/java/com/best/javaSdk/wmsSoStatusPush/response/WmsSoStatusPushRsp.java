package com.best.javaSdk.wmsSoStatusPush.response;
...
public class WmsSoStatusPushRsp
    ...
    public String toString() {
        /* 12 */
        return "WmsSoStatusPushRsp(errors=" + getErrors() + ")";
    }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof com.best.javaSdk.wmsSoStatusPush.response.WmsSoStatusPushRsp;
    }

    public boolean equals(Object o) {
        if (o == this) return true;
        if (!(o instanceof com.best.javaSdk.wmsSoStatusPush.response.WmsSoStatusPushRsp)) return false;
        com.best.javaSdk.wmsSoStatusPush.response.WmsSoStatusPushRsp other = (com.best.javaSdk.wmsSoStatusPush.response.WmsSoStatusPushRsp) o;
