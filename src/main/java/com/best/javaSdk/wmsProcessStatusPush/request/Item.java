...
public class Item {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.best.javaSdk.wmsProcessStatusPush.request.Item)) return false;
        com.best.javaSdk.wmsProcessStatusPush.request.Item other = (com.best.javaSdk.wmsProcessStatusPush.request.Item) o;
        if (!other.canEqual(this)) return false;
        Object this$produceCode = getProduceCode(), other$produceCode = other.getProduceCode();
        if ((this$produceCode == null) ? (other$produceCode != null) : !this$produceCode.equals(other$produceCode))
            return false;
        Object this$batchCode = getBatchCode(), other$batchCode = other.getBatchCode();
        if ((this$batchCode == null) ? (other$batchCode != null) : !this$batchCode.equals(other$batchCode))
            return false;
        Object this$parentSkuCode = getParentSkuCode(), other$parentSkuCode = other.getParentSkuCode();
        if ((this$parentSkuCode == null) ? (other$parentSkuCode != null) : !this$parentSkuCode.equals(other$parentSkuCode))
            return false;
        ...
        if ((this$fixStatusCode == null) ? (other$fixStatusCode != null) : !this$fixStatusCode.equals(other$fixStatusCode))
            return false;
        if (Double.compare(getActualQty(), other.getActualQty()) != 0) return false;
        ...
        return !((this$lotAtt06 == null) ? (other$lotAtt06 != null) : !this$lotAtt06.equals(other$lotAtt06));
    }

    protected boolean canEqual(Object other) {
        return other instanceof com.best.javaSdk.wmsProcessStatusPush.request.Item;
    }

    public int hashCode() {
        int PRIME = 59;
        int result = 1;
        Object $produceCode = getProduceCode();
        result = result * 59 + (($produceCode == null) ? 43 : $produceCode.hashCode());
        Object $batchCode = getBatchCode();
        result = result * 59 + (($batchCode == null) ? 43 : $batchCode.hashCode());
        Object $parentSkuCode = getParentSkuCode();
        result = result * 59 + (($parentSkuCode == null) ? 43 : $parentSkuCode.hashCode());
        Object $fixStatusCode = getFixStatusCode();
        result = result * 59 + (($fixStatusCode == null) ? 43 : $fixStatusCode.hashCode());
        long $actualQty = Double.doubleToLongBits(getActualQty());
        result = result * 59 + (int) ($actualQty >>> 32L ^ $actualQty);
        Object $productDate = getProductDate();
        result = result * 59 + (($productDate == null) ? 43 : $productDate.hashCode());
        ...
        return result * 59 + (($lotAtt06 == null) ? 43 : $lotAtt06.hashCode());
    }

    public String toString() {
        return "Item(produceCode=" + getProduceCode() + ", batchCode=" + getBatchCode() + ", parentSkuCode=" + getParentSkuCode() + ", fixStatusCode=" + getFixStatusCode() + ", actualQty=" + getActualQty() + ", productDate=" + getProductDate() + ", expireDate=" + getExpireDate() + ", lotAtt01=" + getLotAtt01() + ", lotAtt02=" + getLotAtt02() + ", lotAtt03=" + getLotAtt03() + ", lotAtt04=" + getLotAtt04() + ", lotAtt05=" + getLotAtt05() + ", lotAtt06=" + getLotAtt06() + ")";
    }
