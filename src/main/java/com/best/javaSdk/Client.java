...
@Slf4j
 public class Client {
    ...
    public <T extends com.best.javaSdk.BaseResponse> T executed(BaseRequest baseRequest) {
        ...
        /* 39 */
        log.info("请求参数：" + JSONObject.toJSONString(params, new com.alibaba.fastjson2.JSONWriter.Feature[0]));
        ...
        /* 47 */
        return (response == null) ? null : (T) baseRequest.makeResponse(response, this.messageFormat);
